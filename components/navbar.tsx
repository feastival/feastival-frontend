...
export default function Navbar() {
  ...
  <div className="fixed top-0 w-full bg-[#070707] border-gray-200 z-30">
      ...
      <SearchBar/>
        ...
        <div
          className={`fixed top-0 right-0 h-full w-full lg:hidden ${isMenuOpen ? 'block backdrop-blur-lg' : 'hidden'}`}
          onClick={closeMenu}
        >
          <ul className={`absolute top-0 right-0 h-full bg-black text-white p-4 mt-0 space-y-2 font-medium text-center border-l border-gray-100 rounded-lg dark:border-gray-700`}>
