        ...
        <div className="mx-auto">
          ...
          <div className="flex flex-col items-center justify-center mt-8 mb-14">
            ...
            <p className="w-full md:w-[60rem] md:pl-6 p-4 text-justify">
              ...
              user-friendliness are at the heart of everything we do! Our
              mission is to provide you with an unparalleled experience,
              effortlessly guiding you to discover and be reminded of events
              that perfectly match your interests. Imagine a platform that
              understands your preferences and passions, effortlessly curating a
              personalized list of events tailored just for you.
            </p>

            <p className="w-full md:w-[60rem] md:pl-6 p-4 text-justify">
              Gone are the days of spending hours searching through countless
              websites and social media platforms to find the events that truly
              excite you. With our Event Tracker, all you need to do is tell us
              your interests, and we`ll take care of the rest. Our sleek and
