...
export default function Home() {
  return (
    ...
    <div className="left-[98px] top-[188px] absolute text-white text-[88px] font-normal leading-[58px]">FIND AMAZING EVENT<br/>NEAR YOU</div>
    ...
    <img alt="" className="w-[533px] h-[693px] left-[837px] top-0 absolute rounded-[1px] shadow border border-black" src="https://via.placeholder.com/533x693" />
    ...
    <div className="w-[1440px] h-[100px] left-0 top-0 absolute bg-zinc-950">
        <div className="left-[267px] top-[38px] absolute justify-center items-center gap-6 inline-flex">
            <div className="text-base font-normal leading-normal text-white">Home</div>
            <div className="text-base font-normal leading-normal text-white">Explore</div>
            <div className="text-base font-normal leading-normal text-white">Ticket</div>
            <div className="text-base font-normal leading-normal text-white">Community</div>
            <div className="text-base font-normal leading-normal text-white">About</div>
        </div>
        <div className="w-[488px] left-[882px] top-[24px] absolute justify-center items-center gap-4 inline-flex">
            <div className="grow shrink basis-0 h-[52px] pl-4 pr-6 py-3.5 bg-neutral-800 rounded-lg justify-start items-center gap-2 flex">
                ...
                <div className="text-base font-normal leading-normal text-white">Search here..</div>
            </div>
            <div className="px-6 py-3.5 bg-purple-500 rounded-lg justify-center items-center gap-2 flex">
                ...
                <div className="text-base font-normal leading-normal text-white">Login / Register</div>
            </div>
        </div>
        <div className="left-[70px] top-[38px] absolute text-white text-2xl font-normal uppercase leading-normal">FEASTIVAL</div>
    </div>
</div>
  )
}
